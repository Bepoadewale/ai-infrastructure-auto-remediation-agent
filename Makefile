...
.PHONY: install test lint bootstrap-local smoke demo-remediation demo-rollback demo-image-recovery demo-stale-plan cleanroom-validate verify clean-local
