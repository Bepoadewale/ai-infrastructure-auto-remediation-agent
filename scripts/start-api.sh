...
SRE_EXECUTOR=kubernetes KUBE_CONTEXT="kind-$CLUSTER_NAME" SRE_DATABASE="$LOCAL_DIR/remediation.db" "$ROOT/.venv/bin/python" -m uvicorn sre_agent.main:app --host 127.0.0.1 --port 18070 >"$LOCAL_DIR/api.log" 2>&1 &
